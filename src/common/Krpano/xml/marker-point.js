...
const getMarkerPointXml = function (marker, ath, atv, name, useCustomIcon, index, isMarkerPoint, krpanoXOffset) {
  ...
  atv="${atv}"
  zorder="1"
  onclick="prepare_change_scene(panorama_${marker.nextPanoId}, ${marker.nextPanoId}, ${krpanoXOffset - (marker.nextRotation ? marker.nextRotation.y : 0)}, ${isMarkerPoint}, ${ath});"
