...
if (view.vlookat LT -80 OR view.vlookat GT +80, tween(view.vlookat, 0.0, 1.0, easeInOutSine); tween(view.fov, ${defaultFov}, distance(150, 0.8)););
</action>
...
set(hotspot[vr_panorama_${i}].ath, calc(view.hlookat ${calc} ${vrThumbAth * horizontalCount}));
set(hotspot[vr_panorama_text_${i}].ath, calc(view.hlookat ${calc} ${vrThumbAth * horizontalCount}));`
    }
    return result
  })()}
