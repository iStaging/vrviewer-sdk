...
width="${vrThumbWidth}" height="${vrThumbWidth / 2}" onclick="prepare_change_scene(panorama_${panorama.id}, ${panorama.id})" />
...
width="${vrThumbWidth}" height="20" onclick="prepare_change_scene(panorama_${panorama.id}, ${panorama.id})" />`
