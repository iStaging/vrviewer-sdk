...
function krpanoplugin() {
  ...
  window.build_scene = function (nextPanoramaRotation, markerAth, newIndex, oldIndex, oldHLookat) {
    ...
    clock = new THREE.Clock()
    oldHLookat = getCorrectRotation(oldHLookat)
    ...
    if (newImage && oldImage && (markerAth !== undefined)) {
      ...
      assign_object_properties(oldSphere, 'oldSphere', { // ry, ath 決定點與場景要移動至哪個方向
        ry: getCorrectRotation(180 + krpano.view.hlookat + nextPanoramaRotation - oldHLookat - markerAth), // threeJsMoving is before loadscene
        ath: getCorrectRotation(krpano.view.hlookat + nextPanoramaRotation - oldHLookat), // threeJsMoving is before loadscene
        // ry: getCorrectRotation(180 + krpano.view.hlookat - (oldHLookat - markerAth) - markerAth), // threeJsMoving is after if (%3, set(view.hlookat, calc(%3 - (%5 - prevHlookat))));
        // ath: getCorrectRotation(krpano.view.hlookat - (oldHLookat - markerAth)), // threeJsMoving is after if (%3, set(view.hlookat, calc(%3 - (%5 - prevHlookat))));
        atv: 0,
        depth: 0,
        scale: 1,
        ondown() {
  ...
  function getCorrectRotation(value) {
